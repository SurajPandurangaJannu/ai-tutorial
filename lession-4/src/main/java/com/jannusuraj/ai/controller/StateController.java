...
public class StateController {
    ...
    public ResponseEntity<String> listDownStateOfCountry(@RequestParam("country") String country) {
        final PromptTemplate promptTemplate = new PromptTemplate(listDownStatesPrompt);
        final Prompt prompt = promptTemplate.create(Map.of(COUNTRY_PROMPT_PARAM, country));
